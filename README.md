...
<h1 align="center">
    <a href="https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases">
...
![last1](https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases)
> Download These

2. Clone the repo
   ```sh
   git clone https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases
   ```
3. OR

![download](https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases)


4. _Then open the sln (Project Solution) file_

![vsgif](https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases)

5. Find Executable File
   ```sh
   /ProjectName/Bin/Debug/https://github.com/hero-2000/Forgotten-Runiverse-Crypto-Bot-Crypto-Game-Auto-Farm-Clicker-Cheat-Api/releases
   ```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
